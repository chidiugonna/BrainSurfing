...
try 
IMAGE1='/home/chidi/repos/neurobaseoodjupyHssh hpchi Hi oYzoomChiwww/DATA/MNINonLinear/100307.sulc.164k_fs_LR.dscalar.nii';
niinew=niftiread(IMAGE1);
niinfo=niftiinfo(IMAGE1);
catch
   disp('This is not a valid nifti') 
end
...
%hdr is 540 bytes large so we have a nifti2
fid = fopen(IMAGE1);
